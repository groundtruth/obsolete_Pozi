...
var gtWorkspaceName= "CENTRALGOLDFIELDS"; 
var gtFeatureNS = "http://www.pozi.com.au/centralgoldfields";

// Database config for the master search table
var gtDatabaseConfig = "centralgoldfieldsgis";
...
var gtLogoClientSrc = gtServicesHost+"/"+"theme/app/img/CGSC.gif";
var gtLogoClientWidth=89;

// Map resources
// Center determined by: select ST_AsText(ST_Transform(ST_SetSRID(ST_Centroid(the_geom),4283),900913)) from dse_vmadmin_lga where lga_name='CENTRAL GOLDFIELDS'
var gtMapCenter = [15998165, -4440113];
var gtMapZoom = 11;
var gtZoomMax=18;
...
//		source:"localVicmap",
		source:"local",
		name:"VicmapClassicCentralGoldfields",
