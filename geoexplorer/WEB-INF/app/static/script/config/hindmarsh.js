// Javascript configuration file for Hindmarsh Shire

// Workspace containing the layers and corresponding namespace
var gtWorkspaceName= "HINDMARSH";
...
var gtGetLiveDataEndPoints=[
	{ urlLayout:'http://192.168.10.12/ws/rest/v3/ws_get_layouts.php', 	urlLiveData:'http://192.168.10.12/ws/rest/v3/ws_get_live_data.php',	storeMode:'sqlite',	storeName:'hindmarsh'},
...
var gtLogoClientSrc = "http://www.pozi.com/"+"theme/app/img/hindmarsh_logo.png";
var gtLogoClientWidth=190;

// Map resources
// Center determined by: select lga_code,ST_AsText(ST_Transform(ST_SetSRID(ST_Centroid(the_geom),4283),900913)) from dse_vmadmin_lga where lga_name='HINDMARSH'
var gtMapCenter = [15779835, -4307720];
var gtMapZoom = 9;
...
var gtPrintTitle = "Hindmarsh Shire Council";
...
var gtLinkToCouncilWebsite="http://www.hindmarsh.vic.gov.au/";
var gtBannerLineColor="#125333";
var gtBannerRightCornerLine1="Hindmarsh Shire Council";
